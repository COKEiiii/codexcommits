...
try {
    ...
    Invoke-WebRequest "$downloadBase/$assetName" -OutFile $archive
    Invoke-WebRequest "$downloadBase/checksums.txt" -OutFile $checksums
...
Write-Host "Installed codexcommits to $installDir"
